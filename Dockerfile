...
WORKDIR /yamaha-pdf-generator

COPY package*.json ./

# Installing necessary debian deps for Puppeteer
RUN apt-get update && apt-get install \
		-y gconf-service libasound2 libatk1.0-0 libatk-bridge2.0-0 libc6 libcairo2 libcups2 libdbus-1-3 libexpat1 \
